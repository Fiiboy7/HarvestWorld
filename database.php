...
// Fix the image upload function by ensuring the upload directory exists and has proper permissions
...
// Add this function to update the last_active timestamp for a user
