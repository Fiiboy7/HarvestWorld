                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        <a href="toggle-role.php?id=<?php echo $user['id']; ?>" class="text-green-600 hover:text-green-900">
                                            <i class="fas fa-exchange-alt"></i> <?php echo $user['role'] === 'admin' ? 'Jadikan User' : 'Jadikan Admin'; ?>
                                        </a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
